...
training_subjects = [
    1,2,4,5,8,9,13,15,16,19,25,28,31,34,38
]
validation_subjects = [14,17,18,27,35] 
tes_subjects = [3,6,7,10,11,12,20,21,22,23,24,26,29,30,32,33,36,37,39,40]
...
def gendata(data_path,
    ...
    for filename in os.listdir(data_path):
        ...
        if(int(filename.split('C')[0].split('S')[1])>17):
            continue
        ...
        if benchmark == 'xview':
            ...
            isvalidation = (subject_id in validation_subjects)
            istest = (subject_id in tes_subjects)
        else:
            raise ValueError()
    ...
    fp = open_memmap('{}/{}_data.npy'.format(out_path, part),
                     ...
                     shape=(len(sample_label), 3, max_frame, num_joint,
                            max_body))
    seq_len = open_memmap('{}/{}_seqlen.npy'.format(out_path,part),
                          dtype='int64',
                          mode='w+',
