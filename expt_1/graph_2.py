...
class Graph():
    ...
    """
    def __init__(self,
                 layout='ntu-rgb+d', #changed from openpose
                 strategy='spatial',
                 max_hop=1,
                 dilation=1):
    ...
    def get_adjacency(self, strategy):
        ...
        # print("Adjacency",adjacency.dtype)
        for hop in valid_hop:
            adjacency[self.hop_dis == hop] = 1
        # print("Adjacency original",adjacency)
        ...
        if strategy == 'uniform':
            ...
            self.A = A
            # print("Datatype of adjacency matrix",A.dtype)
...
def get_hop_distance(num_node, edge, max_hop=1):
    ...
    # print("Arrive mat",arrive_mat)
    for d in range(max_hop, -1, -1):
        hop_dis[arrive_mat[d]] = d
        # print("Hop dis",hop_dis)
    # print("Final hop_dis",hop_dis,hop_dis.shape)
    return hop_dis
