...
for f in files:
	...
	if (classs<=17):
		...
		if('skel_body1' in keys):
			...
			data_padded=auto_pading(data_new,300)

			print("Shape of data",data_padded.shape)
			np.save('/ssd_scratch/cvit/nateshhariharan/Dataset_NTU_RGBD/ntu60_numpy_300padded/'+name+'.npy',data_padded)
